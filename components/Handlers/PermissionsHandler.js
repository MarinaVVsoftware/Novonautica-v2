		...
		subModules: [
			{
				...
				permissionHigh: [ 'Modificar Usuario Alto Nivel', 'Eliminar Usuario Alto Nivel' ]
			},
			{
				subModuleName: 'Roles',
				permissionsLow: [ 'Crear Rol', 'Ver Rol', 'Modificar Rol Bajo Nivel', 'Eliminar Rol Bajo Nivel' ],
